...
#
# 此脚本通过解析功能规范并使用项目信息更新代理特定配置文件来维护 AI 代理上下文文件。
#
# 主要功能：
# 1. 环境验证
#    - 验证 git 仓库结构和分支信息
...
# 5. 多代理支持
#    - 处理代理特定的文件路径和命名约定
#    - 支持：Claude、Gemini、Copilot、Cursor、Qwen、opencode、Codex、Windsurf、Kilo Code、Auggie CLI 或 Amazon Q Developer CLI
#    - 可以更新单个代理或所有现有代理文件
#    - 如果不存在代理文件，则创建默认 Claude 文件
#
# 用法：./update-agent-context.sh [代理类型]
