...
const modalLayout = ref<'flat' | 'tabs'>('flat');
...
const openModal = (layout: 'flat' | 'tabs') => {
...
<template>
  <div class="page-container">
    <div class="p-6">
      <h1 class="mb-4 text-2xl font-bold">DetailModal 组件演示</h1>
      <p class="mb-6 text-gray-600">
        详情弹窗组件，支持平铺和标签页两种布局模式
      </p>

      <div class="mb-8 flex gap-4">
        <Button type="primary" @click="openModal('flat')">
          打开平铺布局弹窗
        </Button>
        <Button type="primary" @click="openModal('tabs')">
          打开标签页布局弹窗
        </Button>
      </div>
